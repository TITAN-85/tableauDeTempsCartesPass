...
<body>
    ...
    <main>
        <div>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Id, neque, ullam fugiat voluptates enim provident magnam ex tenetur atque omnis nihil pariatur harum. Modi eos ratione velit cumque, natus praesentium?
        </div>
    </main>
    <footer>
        <div>
