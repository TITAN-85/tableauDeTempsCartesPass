...
<body>
    ...
    <nav>
        ...
        <div class="formTt infoColor">Effectuer une attaque par force brute sur le mot de passe.</div>
        <a href="cartes.php" role="menuitem" aria-roledescription="menuitem">Paquet de cartes</a>
        <div class="formTt infoColor"> Un paquet de cartes brassé de manière aléatoire et différente à chaque rafraîchissement</div>
    </nav>
</body>
</html>